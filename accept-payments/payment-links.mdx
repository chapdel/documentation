...
[//]: # (fetch&#40;'https://api.notchpay.co/quick', {)
...
[//]: # (    payment_methods: ['cm.mtn', 'cm.orange', 'assoh'], / Optional)
...
- Check the [API Reference](/api-reference/payment-links) for detailed parameter documentation

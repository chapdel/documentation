...
- Check the [API Reference](/api/refunds) for detailed parameter documentation
...
- [Disputes](/docs/accept-payments/disputes) - Learn how to handle payment disputes
- [Webhooks](/docs/webhooks) - Set up webhooks for payment and refund notifications
- [API Integration](/docs/accept-payments/api-integration) - Build a custom payment experience
- [Testing](/docs/testing) - Test your refund implementation in the sandbox environment
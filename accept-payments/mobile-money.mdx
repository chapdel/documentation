...
For more information on testing, see the [Testing Guide](/testing).

## Next Steps

- [Collect](/accept-payments/collect) - Use our hosted payment page for a quick integration
- [API Integration](/accept-payments/api-integration) - Build a custom payment experience
- [Invoices](/accept-payments/invoices) - Create and manage professional invoices
- [Webhooks](/webhooks) - Set up webhooks for payment notifications
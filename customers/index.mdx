...
- **API**: Programmatically create customers using the [Customers API](/api-reference/customers)
...
Learn more about creating and managing customers in the [Customers API](/api-reference/customers).
...
Learn more about customer payment methods in the [Customers API](/api-reference/customers).
...
Learn more about the Customer Portal in your [Notch Pay Dashboard](https://business.notchpay.co).
...
- **API**: Integrate with our [Customers API](/api-reference/customers) for programmatic customer management
...
- [Customers API](/api-reference/customers) - API reference for programmatic customer management
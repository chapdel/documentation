...
| `customer.blocked` | Triggered when a customer is blocked |
| `customer.unblocked` | Triggered when a customer is unblocked |
...
- [Webhooks API](/api-reference/webhooks) - Learn about webhook events and how to manage your webhook endpoints
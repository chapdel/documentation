...
Each of these keys exists in both sandbox (test) and production environments. It's important to use the correct set of keys for each environment:
...
Never mix keys between environments. Always use sandbox keys for testing and production keys for live transactions.
...
3. Find your webhook endpoint and note the "Webhook Hash"

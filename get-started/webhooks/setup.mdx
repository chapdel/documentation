...
4. Enter your webhook URL (e.g., `https://example.com/webhooks/notchpay` or your ngrok URL for testing)
5. Select the events you want to receive notifications for
6. Optionally, add a description to help you identify this webhook
...
1. In your Notch Pay dashboard, go to **Settings** > **Developers** > **Webhooks**
2. Find your webhook endpoint and click the **Test** button
3. Select an event type to test (e.g., `payment.complete`)
...
- [Webhook Overview](/get-started/webhooks/index) - Learn more about webhooks and how they work

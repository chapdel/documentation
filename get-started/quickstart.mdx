...
<Steps>
  <Step title="Get Your API Keys">
    <Tabs>
      ...
      <Tab title="Test vs Live">
        ...
        Test keys start with `test_` while live keys start with `live_`.
      </Tab>
    </Tabs>
  </Step>
  ...
  <Step title="Redirect to the Payment Page">
    ...
    <Frame>
      <img src="/images/payment-page-example.png" alt="Notch Pay Payment Page" />
    </Frame>
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Webhook Setup" icon="bell" href="/get-started/webhooks/setup">

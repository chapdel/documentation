...
- [Test Mode](/testing/test-mode) - Learn more about the test environment
- [Mobile Money](/accept-payments/mobile-money) - Comprehensive guide on integrating Mobile Money payments
- [Production Checklist](/testing/test-mode#production-checklist) - Make sure you're ready for production
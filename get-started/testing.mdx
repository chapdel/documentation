...
description: Learn how to test your Notch Pay integration with Mobile Money test accounts
---
...
- [Webhook Setup](/get-started/webhooks/index) - Learn how to set up webhook endpoints
...
> **Important**: For a complete understanding of our fraud detection system, please refer to our [Complete Guide to Fraud Detection System](/security/fraud-detection).
...
7. Understand our [fraud detection system](/security/fraud-detection) and its implications
...
- [Mobile Money](/accept-payments/mobile-money) - Comprehensive guide on integrating Mobile Money payments
- [Production Checklist](#production-checklist) - Make sure you're ready for production

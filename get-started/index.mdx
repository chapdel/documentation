...
Welcome to Notch Pay! This guide will help you get started with our payment platform and show you how to integrate our services into your business or application.
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
  <div className="border rounded-lg p-6 hover:shadow-md transition-shadow">
    ...
    <a href="/api" className="text-blue-600 hover:underline">View API Documentation →</a>
  </div>
  <div className="border rounded-lg p-6 hover:shadow-md transition-shadow">
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
  <div className="border rounded-lg p-6 hover:shadow-md transition-shadow">
    ...
    <a href="/docs/sdks" className="text-blue-600 hover:underline">Explore SDKs →</a>
  </div>
  <div className="border rounded-lg p-6 hover:shadow-md transition-shadow">
    ...
    <a href="/docs/accept-payments/checkout" className="text-blue-600 hover:underline">Learn about Checkout →</a>
  </div>
</div>
...
- [Quickstart Guide](/docs/get-started/quickstart) - Get up and running with Notch Pay in minutes
- [Dashboard Overview](/docs/dashboard/overview) - Learn how to navigate and use the Notch Pay dashboard
- [Account Setup](/docs/get-started/account-setup) - Configure your account settings for optimal use
- [Accept Payments](/docs/accept-payments) - Explore different ways to accept payments
...
2. Use our [test credentials and accounts](/docs/testing/test-mode)
...
- Check our [FAQ](/docs/faq) for answers to common questions

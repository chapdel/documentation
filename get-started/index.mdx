...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
  ...
  <div className="border rounded-lg p-6 hover:shadow-md transition-shadow">
    ...
    <p className="mb-4">Use our hosted payment page for a quick and secure integration.</p>
    <a href="/accept-payments/collect" className="text-teal-600 hover:underline">Learn about Collect →</a>
  </div>
</div>
...
- [Authentication](/get-started/authentication) - Learn how to authenticate with the Notch Pay API
...
2. Use our [test credentials and accounts](/get-started/testing)

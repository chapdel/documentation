...
For more information about error responses, see the [Error Handling](/docs/get-started/errors) guide.
...
- [Authentication](/docs/get-started/authentication) - Learn about authentication methods
- [Error Handling](/docs/get-started/errors) - Understand how to handle API errors
    ...
    <div className="flex items-start">
      ...
      <div>
        ...
        <Callout type="info" className="mt-3">
          Test cards and accounts are available in the <a href="/testing" className="text-blue-500 hover:underline">Testing Guide</a>.
        </Callout>
      </div>
    </div>
  </Tab>
...
<Callout type="success">
  Ready to start building? Check out our [Quickstart Guide](/get-started/quickstart) to make your first API request.
</Callout>
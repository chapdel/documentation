...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
  <div className="border rounded-lg p-6 hover:shadow-md transition-shadow">
    ...
    <a href="/docs/dashboard/overview" className="text-blue-600 hover:underline">Learn more →</a>
  </div>
  <div className="border rounded-lg p-6 hover:shadow-md transition-shadow">
    <h3 className="text-lg font-semibold mb-2">Payments</h3>
    <p className="mb-4">Create, view, and manage payment transactions.</p>
    <a href="/docs/dashboard/transactions#payments" className="text-blue-600 hover:underline">Learn more →</a>
  </div>
</div>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
  <div className="border rounded-lg p-6 hover:shadow-md transition-shadow">
    ...
    <a href="/docs/dashboard/transactions#transfers" className="text-blue-600 hover:underline">Learn more →</a>
  </div>
  <div className="border rounded-lg p-6 hover:shadow-md transition-shadow">
    <h3 className="text-lg font-semibold mb-2">Customers</h3>
    <p className="mb-4">Manage customer information and payment methods.</p>
    <a href="/docs/customers" className="text-blue-600 hover:underline">Learn more →</a>
  </div>
</div>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
  <div className="border rounded-lg p-6 hover:shadow-md transition-shadow">
    ...
    <a href="/docs/send-money/beneficiaries" className="text-blue-600 hover:underline">Learn more →</a>
  </div>
  <div className="border rounded-lg p-6 hover:shadow-md transition-shadow">
    <h3 className="text-lg font-semibold mb-2">Reports</h3>
    <p className="mb-4">Generate and analyze financial reports.</p>
    <a href="/docs/dashboard/reports" className="text-blue-600 hover:underline">Learn more →</a>
  </div>
</div>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
  <div className="border rounded-lg p-6 hover:shadow-md transition-shadow">
    ...
    <a href="/docs/dashboard/settings" className="text-blue-600 hover:underline">Learn more →</a>
  </div>
  <div className="border rounded-lg p-6 hover:shadow-md transition-shadow">
    <h3 className="text-lg font-semibold mb-2">Developers</h3>
    <p className="mb-4">Access API keys, webhooks, and developer resources.</p>
    <a href="/docs/dashboard/settings#developer-settings" className="text-blue-600 hover:underline">Learn more →</a>
  </div>
</div>
...
- [Dashboard Overview](/docs/dashboard/overview) - Learn about the main dashboard interface
- [Transactions](/docs/dashboard/transactions) - Manage payments and transfers
- [Reports](/docs/dashboard/reports) - Generate and analyze financial reports
- [Settings](/docs/dashboard/settings) - Configure your account settings
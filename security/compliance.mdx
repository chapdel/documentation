...
- **PCI DSS (Payment Card Industry Data Security Standard)**: Ensures secure handling of payment information
...
- [Terms of Service](https://notchpay.co/legals/terms)
- [Privacy Policy](https://notchpay.co/legals/privacy)
- [AML Policy](https://notchpay.co/legals/aml)
- [Acceptable Use Policy](https://notchpay.co/legals/acceptable-use)
- [Data Protection Policy](https://notchpay.co/legals/data-protection)
